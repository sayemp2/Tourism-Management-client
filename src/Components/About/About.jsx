const About = () => {
    ...
    return (
        <div className="mt-20 mb-7">
            ...
            <div className="flex md:flex-row flex-col  items-center bg-[#1d231f] ">
                <div className="md:w-1/2 px-3"><img src="../../../public/small-house-built-peaceful-green-hill-high-up-mountains.jpg" alt="" /></div>
                <div className="md:w-1/2 md:p-5 border-l-2 border-[#63ab45]">
                    <h3 className="text-[#63ab45] mb-2 font-Montserrat md:text-2xl text-xl font-semibold">Our benefit lists</h3>
                    <h1 className="md:text-5xl text-3xl font-Montserrat mb-5  text-white font-semibold">Why Choose SemWilds</h1>
                    ...
                    <div>
                        <h3 className="font-Montserrat md:text-xl text-white font-medium">Professional and Certified</h3>
                        <p className="font-Montserrat">We are the most fun travel and tours company</p>
                    </div>
                    <div>
                        <h3 className="font-Montserrat md:text-xl text-white font-medium">Get Instant Tour Bookings</h3>
                        <p className="font-Montserrat">We are the most fun travel and tours company,</p>
                    </div>
                </div>
            </div>
