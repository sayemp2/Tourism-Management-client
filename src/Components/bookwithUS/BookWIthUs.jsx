    ...
    return (
        <div className="flex md:flex-row flex-col items-center mb-3">
            ...
            <div className="md:w-1/2 w-11/12 mx-auto">
                <h1 className="font-Montserrat font-semibold md:text-5xl text-3xl mb-12 text-white">Plan Your Trip with <br /> Trevily</h1>
                ...
                <button className="bg-[#63ab45] px-10 rounded-lg transition-all duration-1000 font-semibold py-2 md:text-xl text-white hover:bg-black">BOOK  WITH  US</button>
            </div>
        </div>
    );
};
