...
const Service = () => {
    return (
        <div className='mb-4  '>
            <h3 className="lg:text-2xl mb-6 text-center font-bold text-[#63ab45] font-Montserrat">About Service</h3>
            ...
            <div className='grid  lg:grid-cols-3  justify-center grid-cols-1 space-y-3'>
                <div className='bg-[#292b29] rounded-2xl md:w-96 sm:w-56  flex flex-col justify-start pt-20  px-10 pb-7 mx-auto'>
                ...
                <div className='bg-[#292b29] rounded-2xl md:w-96 sm:w-56  flex flex-col justify-start pt-20  px-8 pb-7 mx-auto'>
                ...
                <div className='bg-[#292b29] rounded-2xl md:w-96 sm:w-56   flex flex-col justify-start pt-20  px-5 pb-7 mx-auto'>
